...
function applySettingsToUI() {
  ...
  if (epocaSelect) epocaSelect.value = settings.epoca;
  if (humThresholdEl) humThresholdEl.value = settings.humThreshold;
  if (lightsStartEl) lightsStartEl.value = settings.lightsStart;
  if (lightsEndEl) lightsEndEl.value = settings.lightsEnd;
  if (pumpIntervalEl) pumpIntervalEl.value = settings.pumpInterval;
}
...
function syncSettingsFromInputs() {
  ...
  if (pumpIntervalEl) settings.pumpInterval = pumpIntervalEl.value;
...
const autoSettingsInputs = [espIpEl, mqttHostEl, mqttPortEl, mqttUserEl, mqttPasswordEl, epocaSelect, humThresholdEl, lightsStartEl, lightsEndEl, pumpIntervalEl].filter(Boolean);
